	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="manageuser/edit.htm"> <i class="fas fa-fw fa-table"></i> <span>Quản
						lý người dùng</span></a></li>
			<li class="nav-item"><a class="nav-link"
				href="quanlyhatgiong/edit.htm"> <i class="fas fa-fw fa-table"></i>
					<span>Quản lý hạt giống</span></a></li>
			<li class="nav-item"><a class="nav-link"
